...
object SupabaseClient {
    ...
    internal const val SUPABASE_URL = "https://jcrodmrmuaegvcymbpog.supabase.co"
    internal const val ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Impjcm9kbXJtdWFlZ3ZjeW1icG9nIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzkxMzAyOTYsImV4cCI6MjA5NDcwNjI5Nn0.aH7OComWskJn9iC3UXGQCCogknqbrrt4rYDD23UZYzg"
    ...
    fun signUp(email: String, password: String, fullName: String, role: String): JSONObject {
